...
import jazzyPic from "../../assets/Frame 3.jpg";
      ...
      <div className="col-sm-12 col-lg-9 ">
        {isLoading ? (
          ...
          <div className="d-flex flex-wrap justify-content-between align-items-center gap-4">
            {data.map((datum) => {
              const { _id, image, title, description, price } = datum;
              return (
                <Card
                  key={_id}
                  className="rounded-4 card-inner position-relative"
                >
                  <Card.Img variant="top" src={image} className="w-100" />
                  <Card.Img
                    variant="top"
                    src={heartImg}
                    className="w-25 position-absolute  end-0 top-0 rounded-pill p-2"
                  />
                  ...
                  <Card.Body>
                    ...
                    <div className=" my-3 d-flex justify-content-between">
                      <Card.Img variant="top" src={cheeseImg} />
                      <Card.Img variant="top" src={onionImg} />
                      <Card.Img variant="top" src={lettuceImg} />
                      <Card.Img variant="top" src={breadImg} />
                      <Card.Img variant="top" src={eggImg} />
                    </div>
